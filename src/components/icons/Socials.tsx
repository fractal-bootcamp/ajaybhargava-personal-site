export const GitHub = () => {
    return (
    <a href="https://github.com/ajay-bhargava">
...
return (
    <a href="https://linkedin.com/in/ajaybhargava">
        <button type='button' style={{
            border: 'none',
            background: 'none',
        }}>
...
export const Twitter = () => {
    return (
        <a href="https://x.com/ajay_bhargava">
            <button type='button' style={{
                border:'none',
                background:'none',
            }}>
                ...
                transform="rotate(0 0 0)">
                    <title>Twitter</title>
                    <path d="M17.7512 2.96094H20.818L14.1179 10.6187L22 21.0391H15.8284L10.9946 14.7191L5.4636 21.0391H2.39492L9.56132 12.8483L2 2.96094H8.32824L12.6976 8.73762L17.7512 2.96094ZM16.6748 19.2035H18.3742L7.40492 4.70014H5.58132L16.6748 19.2035Z" fill="#343C54"/>
                </svg>
            </button>
        </a>
    )
...
export const Scholar = () => {
    return (
        <a href="https://scholar.google.ca/citations?user=Cr4HEHYAAAAJ&hl=en">
            <button type='button' style={{
                border: 'none',
                background:'none',
            }}>
                <svg fill="#000000" width="24" height="24" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
                <title>Scholar</title><g id="SVGRepo_bgCarrier" stroke-width="0" />
